...
void loop() {
    ...
    if (drawTime < 100) {
        tft.drawString("Font 1 not loaded!", 0, 108, 2);
    }
    ...
    tft.drawFloat(drawTime / 2890.0, 3, 0, 80, 4);
    if (drawTime < 200) {
        tft.drawString("Font 2 not loaded!", 0, 108, 2);
    }
    ...
    tft.drawFloat(drawTime / 2890.0, 3, 0, 80, 4);
    if (drawTime < 200) {
        tft.drawString("Font 4 not loaded!", 0, 108, 2);
    }
    ...
    tft.drawFloat(drawTime / 2890.0, 3, 0, 80, 4);
    if (drawTime < 200) {
        tft.drawString("Font 6 not loaded!", 0, 108, 2);
    }
    ...
    tft.drawFloat(drawTime / 2890.0, 3, 0, 80, 4);
    if (drawTime < 200) {
        tft.drawString("Font 7 not loaded!", 0, 108, 2);
    }
    ...
    if (drawTime < 200) {
        tft.drawString("Font 8 not loaded!", 0, 108, 2);
    }
