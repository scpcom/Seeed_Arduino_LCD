...
void loop() {
    ...
    fillSegment((LCD_W/2), (LCD_H/2), 0, 60, LCD_SCALE(100), TFT_RED);
    fillSegment((LCD_W/2), (LCD_H/2), 60, 30, LCD_SCALE(100), TFT_GREEN);
    fillSegment((LCD_W/2), (LCD_H/2), 60 + 30, 120, LCD_SCALE(100), TFT_BLUE);
    fillSegment((LCD_W/2), (LCD_H/2), 60 + 30 + 120, 150, LCD_SCALE(100), TFT_YELLOW);

    delay(4000);

    // Erase old chart with 360 degree black plot
    fillSegment((LCD_W/2), (LCD_H/2), 0, 360, LCD_SCALE(100), TFT_BLACK);
}
