...
void loop() {
    ...
    fillArc((LCD_W/2), (LCD_H/2), inc * 6, 1, LCD_SCALE(140), LCD_SCALE(100), LCD_SCALE(10), rainbow(col));

    // Continuous segmented (inc*2) elliptical arc drawing
    fillArc((LCD_W/2), (LCD_H/2), ((inc * 2) % 60) * 6, 1, LCD_SCALE(120), LCD_SCALE(80), LCD_SCALE(30), rainbow(col));

    // Circle drawing using arc with arc width = radius
    fillArc((LCD_W/2), (LCD_H/2), inc * 6, 1, LCD_SCALE(42), LCD_SCALE(42), LCD_SCALE(42), rainbow(col));
