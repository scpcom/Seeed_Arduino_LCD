...
void initgame() {
    ...
    tft.fillRect(0, h - 26, w, h - 1, GREY);
...
void midline() {
    ...
    for (int16_t i = 0; i < dashline_n; i += 2) {
        tft.fillRect(dashline_x, top, dashline_w, dashline_h, WHITE);
        top+=dashline_h;
        tft.fillRect(dashline_x, top, dashline_w, dashline_h, BLACK);
        top+=dashline_h;
    }
