            ...
            for (int32_t x = 0; x < this->gWidth[gNum]; x++) {
                ...
                if (pixel) {
                    if (pixel != 0xFF) {
                        ...
                        if (_bpp != 1) {
                            drawPixel(x + this->cursor_x + this->gdX[gNum], y + this->cursor_y + this->gFont.maxAscent - this->gdY[gNum],
                                      alphaBlend(pixel, fg, bg));
                        } else if (pixel > 127) {
                            drawPixel(x + this->cursor_x + this->gdX[gNum], y + this->cursor_y + this->gFont.maxAscent - this->gdY[gNum], fg);
                        }
                    } else {
                        if (dl == 0) {
